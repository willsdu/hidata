...
from hidata.providers.openai_provider import OpenAIProvider
...
class ProviderManager:
    ...
    def update_local_models(self) -> None:
        """Refresh local provider models (best-effort).

        Some local providers (e.g. LM Studio / llama.cpp) may optionally support
        discovery. If not implemented, this is a no-op and should never block
        app startup.
        """
        return
